...
class document {
public:
	//words is a array store all word, which actually is the number in wordmap
    int * words;
    string rawstr;
    int length;
...
public:
    ...
    int read_trndata(string dfile,string rfile, string wordmapfile,string referencemapfile);
